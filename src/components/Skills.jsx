...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      { name: 'SQL', icon: FiDatabase, level: 80, color: '#4479A1' },
  ...
  return (
    <section id="skills" className="section-padding">
      <div className="max-w-7xl mx-auto" ref={ref}>
        ...
        >
          <span className="text-primary-500 font-mono text-sm font-semibold tracking-wider uppercase">
            Tech Stack
          </span>
          ...
          {skillCategories.map((cat, i) => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-display font-bold text-gray-800 dark:text-white text-lg">
                  {cat.title}
                </h3>
              </div>
        ...
        >
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mb-6 font-mono">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {[
              ...
              { icon: SiGithub, color: '#6e40c9', name: 'GitHub' },
